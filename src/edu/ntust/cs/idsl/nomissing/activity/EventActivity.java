...
public class EventActivity extends Activity {
    ...
    private static final String ACTION = "edu.ntust.cs.idsl.nomissing.action.EVENT";
    ...
    public static void startAction(Context context, long reminderID) {
        context.startActivity(getAction(context, reminderID));
    }
    
    public static Intent getAction(Context context, long reminderID) {
    ...
    private void openEventDialog(final Event event) {
        ...
        message.append(getString(R.string.event_title) + "¡G" + event.getTitle() + "\n");
        if (!event.getLocation().isEmpty())
            message.append(getString(R.string.event_location) + "¡G" + event.getLocation() + "\n");
        message.append(getString(R.string.event_start_time) + "¡G" + formatter.format(event.getStartTime()) + "\n");
        message.append(getString(R.string.event_end_time) + "¡G" + formatter.format(event.getEndTime()));
