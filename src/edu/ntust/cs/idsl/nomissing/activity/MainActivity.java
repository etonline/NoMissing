...
public class MainActivity extends FragmentActivity implements OnItemClickListener {
    ...
    private void setNavigationDrawer() {
        ...
        drawerMenu.setAdapter(new NavDrawerListAdapter(getApplicationContext(),
                navDrawerItems));
    ...
    private void openSettingCalendarDialog() {
        final List<Calendar> calendars = DaoFactory
                .getCalendarProviderDaoFactory().createCalendarDao(this)
        ...
        new AlertDialog.Builder(this)
                ...
                .setItems(
                        Calendar.getNameOfCalendars(calendars).toArray(
                                new String[calendars.size()]),
                        new OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog,
                                    int which) {
                                app.getSettings().setCalendarID(
                                        calendars.get(which).getId());
                            }
                        }).show();
    }
