...
public class WeatherExpandListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        TextView textViewRegion = (TextView) convertView
                .findViewById(android.R.id.text1);
        TextView textViewRegionCities = (TextView) convertView
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        Weather weather = DaoFactory.getSQLiteDaoFactory().createWeatherDao(context).find(childList.get(groupPosition).get(childPosition).getCityID());
