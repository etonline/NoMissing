...
public class EventDao extends SQLiteDao implements IEventDao {
    ...
    private static final String[] EVENTS_COLUMNS = new String[] {
            NoMissingDB.EVENTS_KEY_ID, NoMissingDB.EVENTS_KEY_CALENDAR_ID,
            NoMissingDB.EVENTS_KEY_TITLE, NoMissingDB.EVENTS_KEY_LOCATION,
            NoMissingDB.EVENTS_KEY_DESCRIPTION,
            NoMissingDB.EVENTS_KEY_START_TIME, NoMissingDB.EVENTS_KEY_END_TIME,
    ...
    public long update(Event event) {
        ...
        open();
        int row = db.update(NoMissingDB.TABLE_EVENTS, values, whereClause,
                whereArgs);
        close();
    ...
    public List<Event> find(long calendarID, long startMillis, long endMillis) {
        ...
        String selection = "((" + NoMissingDB.EVENTS_KEY_CALENDAR_ID + " = ?) " + 
    ...
    @Override
    public Event find(long eventID, long calendarID, long startMillis,
            long endMillis) {
        Event event = new Event();
        ...
        String[] selectionArgs = new String[] { String.valueOf(eventID),
                String.valueOf(calendarID), String.valueOf(startMillis),
                String.valueOf(endMillis) };

        open();
        Cursor cursor = db.query(NoMissingDB.TABLE_EVENTS, EVENTS_COLUMNS,
