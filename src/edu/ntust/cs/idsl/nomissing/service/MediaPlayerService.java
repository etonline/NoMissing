...
public class MediaPlayerService extends Service implements
    ...
    public static final String ACTION_PLAY = "edu.ntust.cs.idsl.nomissing.action.PLAY_MEDIA_PLAYER";
    public static final String ACTION_PAUSE = "edu.ntust.cs.idsl.nomissing.action.PAUSE_MEDIA_PLAYER";
    public static final String ACTION_STOP = "edu.ntust.cs.idsl.nomissing.action.STOP_MEDIA_PLAYER";
