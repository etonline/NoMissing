...
public class TTSGetConvertStatusService extends TextToSpeechService {
    ...
    protected void handleAction(final Bundle extras) {
        ...
        NoMissingHttpClient.ttsGetConvertStatus(app.getSettings().getUUID(), app.getSettings().getAccessToken(), params,
                new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        ...
                        try {
                            ...
                            if (status == TTSGetConvertStatusResultCode.CONVERT_STATUS_COMPLETED) {
                                ...
                                sendBroadcast(TTSServiceReceiver.getActionReceiveTTSServiceUpdateProgress(TTSGetConvertStatusService.this));
                    ...
                    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                        ...
                        sendBroadcast(TTSServiceReceiver.getActionReceiveTTSServiceFailure(TTSGetConvertStatusService.this));
                    }
                });
    }
